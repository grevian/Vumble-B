 ...
 *
 * $LastChangedDate: 2010-12-27 08:54:43 -0700 (Mon, 27 Dec 2010) $
 * $Revision: 1116 $
 * $LastChangedBy: clearscreen $
 * $URL: http://svn.mangler.org/mangler/tags/1.2.2/libventrilo3/libventrilo3.c $
 *
...
#if defined(HAVE_CELT) || defined(HAVE_SPEEX)
    ...
    switch (msg->type) {
        ...
        case 0x50:/*{{{*/
            if (!_v3_get_0x50(msg)) {
                ...
                v3_user *u;
                uint8_t VARIABLE_IS_NOT_USED guest = false;
                char **motd;
                int size = 0;
                _v3_lock_server();
...
int
v3_queue_size(void) {/*{{{*/
    _v3_net_message VARIABLE_IS_NOT_USED *msg;
    int ctr;
